...
class SideBarFrame(ctk.CTkFrame):
    def __init__(self, master, controller):
        ...
        # Search Button
        self.searchButton = ctk.CTkButton(self, image=ctk.CTkImage(light_image=Image.open("./icons/icons8-search-24-black.png"), dark_image=Image.open("./icons/icons8-search-24.png"), size=(30, 30)), fg_color=("gray86", "gray17"), text="", width=75, command=lambda: controller.showFrame(SearchFrame.SearchFrame))
        ...
        # Profile Button
        self.profileButton = ctk.CTkButton(self, image=ctk.CTkImage(light_image=Image.open("./icons/icons8-name-24-black.png"), dark_image=Image.open("./icons/icons8-name-24.png"), size=(30, 30)), fg_color=("gray86", "gray17"), text="", width=75, command=lambda: controller.showFrame(ProfileFrame.ProfileFrame))
