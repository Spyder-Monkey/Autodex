...
class SideBarFrame(ctk.CTkFrame):
    def __init__(self, master):
        ...
        # Home Button
        self.homeButton = ctk.CTkButton(self, image=ctk.CTkImage(light_image=Image.open("./icons/icons8-home-24-black.png"), dark_image=Image.open("./icons/icons8-home-24-white.png"), size=(30, 30)), fg_color=("gray86", "gray17"), text="", width=75, hover_color="#F5D547")
